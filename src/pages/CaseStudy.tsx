...
export const CaseStudy: React.FC = () => {
  ...
  if (!project) {
    return (
      <div className="min-h-[80svh] flex flex-col items-center justify-center text-center p-8">
        ...
        <Button onClick={() => navigate('/work')}>Back to Archive</Button>
      </div>
    );
  }
  ...
  return (
    <article className="relative min-h-[100svh] pt-28 pb-24">
      {/* 1. Case Hero (PRD §13.2, §13.3) */}
      <section className="w-full max-w-[1696px] mx-auto px-[var(--margin)] mb-16 md:mb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
          ...
          <div className="lg:col-span-8">
            ...
            <h1 className="text-display text-[44px] sm:text-[64px] md:text-[84px] lg:text-[96px] text-[var(--color-fg)] font-semibold tracking-[-0.035em] leading-[0.95]">
              {project.title}
            </h1>
          </div>
      ...
      <div className="w-full max-w-[1696px] mx-auto px-[var(--margin)]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-8 lg:col-start-5 flex flex-col gap-20 md:gap-28">
            {/* 2. Overview */}
            <section>
      ...
      {/* 13. Next Project Footer Banner (PRD §13.2) */}
      <section className="mt-32 pt-20 border-t border-[var(--color-border)]">
        <div className="w-full max-w-[1696px] mx-auto px-[var(--margin)]">
          <div className="flex items-baseline justify-between mb-8">
            ...
            <Link to="/work" className="text-meta draw-underline">
              Back to Archive
            </Link>
          </div>
