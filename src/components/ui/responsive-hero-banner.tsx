...
export const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
  ...
  return (
    <section className="w-full max-w-full isolate min-h-[100svh] overflow-hidden relative flex flex-col justify-between pt-[clamp(4.5rem,7.5vh,6.5rem)] pb-[clamp(0.75rem,2vh,2.5rem)] bg-[#0A0A0A]">
      ...
      <div className="z-10 relative px-4 sm:px-6 max-w-5xl mx-auto w-full pb-[clamp(0.5rem,1.5vh,1rem)] overflow-hidden">
