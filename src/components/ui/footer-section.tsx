...
export function FooterSection({
  ...
  const navigationColumns: FooterNavColumn[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Download R̩sum̩ (PDF)", href: siteData.resume?.url || "/assets/resume.pdf", isExternal: true }
      ]
    },
    {
      title: "Inquiries",
  ...
  return (
    <footer className={`w-full max-w-full bg-[#0A0A0A] text-white relative overflow-hidden isolate ${className}`}>
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 pt-16 pb-12 relative z-10">
        {/* Top Section: Brand + Newsletter */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 pb-14 border-b border-white/10 items-start">
          {/* Brand Info */}
          <div className="lg:col-span-6 space-y-4">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white font-haas uppercase">
              {brandName}
            </h2>
            
            <p className="text-[15px] sm:text-[16px] text-white/70 max-w-md leading-relaxed font-sans">
              {brandDescription}
            </p>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-9.5 h-9.5 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-white/10 hover:border-[#FF4500]/40 hover:shadow-[0_0_15px_rgba(255,69,0,0.25)] transition-all duration-200 hover:scale-110 active:scale-95"
          ...
          {showNewsletter && (
            <div className="lg:col-span-6 flex flex-col justify-between bg-white/[0.03] border border-white/10 ring-1 ring-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-md relative overflow-hidden shadow-xl transition-all duration-300">
              ...
              <div className="space-y-2 mb-6 relative z-10">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white font-haas tracking-tight leading-snug">
