...
export function CardStack<T extends CardStackItem>({
  ...
  const cardSpacing = isMobile 
    ...
    : Math.max(10, Math.round(responsiveWidth * (1 - overlap)));
  const stepDeg = maxOffset > 0 ? (isMobile ? 8 : spreadDeg) / maxOffset : 0;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: Math.max(380, responsiveHeight + 70) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
