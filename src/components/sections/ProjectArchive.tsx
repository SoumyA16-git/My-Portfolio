...
export const ProjectArchive: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Orange-Red Ambient Glow matching Hero, About & Certifications tone */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] sm:w-[1300px] lg:w-[1600px] h-[600px] sm:h-[800px] lg:h-[1000px] bg-gradient-to-r from-[#FF4500]/12 via-[#FF3E1D]/08 to-[#FF4500]/10 blur-[170px] pointer-events-none -z-10 rounded-full" />
