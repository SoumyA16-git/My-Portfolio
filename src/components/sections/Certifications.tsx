...
export const Certifications: React.FC = () => {
  ...
  return (
    <section
      id="certifications"
      className="relative w-full max-w-full bg-[#0A0A0A] text-white border-none isolate py-16 sm:py-24 lg:py-28 overflow-hidden"
    >
      ...
      >
        <img
          ...
          className="w-full max-w-[600px] sm:max-w-[850px] lg:max-w-[1100px] h-auto object-contain opacity-25 sm:opacity-30 transform-gpu brightness-[0.72] contrast-[1.3] drop-shadow-[0_0_95px_rgba(255,69,0,0.32)] translate-y-4"
        />
      </div>
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 sm:mb-14">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-[15px] sm:text-[18px] text-white/75 leading-relaxed font-normal max-w-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4 lg:gap-4.5">
          {certificationsData.map((cert) => (
            <div
              key={cert.id}
              className="relative rounded-2xl bg-white/[0.03] border border-white/10 ring-1 ring-white/5 backdrop-blur-md p-4 sm:p-5 flex flex-col justify-between shadow-lg overflow-hidden h-full"
            >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="w-8.5 h-8.5 rounded-xl bg-white/[0.06] border border-white/15 flex items-center justify-center p-1.5 shadow-sm shrink-0">
                      ...
                      <div className="min-w-0">
                        ...
                        {/* Category Label */}
                        <div className="text-[11.5px] sm:text-xs font-medium text-white/80 truncate">
                          {cert.category}
                        </div>
                      </div>
                    </div>
                  ...
                  <h3 className="font-haas font-bold text-[15px] sm:text-[16px] text-white tracking-tight leading-snug pt-3.5">
                    {cert.title}
                  </h3>

                  {/* Clean Description Text */}
                  <p className="text-[12.5px] sm:text-[13px] text-white/60 leading-relaxed font-normal pt-2">
                    {cert.description}
                  </p>
                </div>
              </div>
