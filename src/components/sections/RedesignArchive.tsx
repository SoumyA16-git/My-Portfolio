...
export const RedesignArchive: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Designer Silhouette Watermark in Left Background matching Project Archive & Certifications effect */}
      <div
        className="absolute inset-y-0 left-[1%] sm:left-[3%] lg:left-[5%] xl:left-[6%] w-full max-w-[clamp(520px,58vw,1100px)] flex items-center justify-center pointer-events-none select-none -z-10"
        style={{
          maskImage: 'linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.85) 15%, rgba(0,0,0,0.85) 82%, rgba(0,0,0,0) 98%)',
          WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.85) 15%, rgba(0,0,0,0.85) 82%, rgba(0,0,0,0) 98%)'
        }}
        aria-hidden="true"
      >
        <img
          src="/designer.webp"
          alt=""
          className="w-full h-auto max-h-[105%] object-contain opacity-20 sm:opacity-25 lg:opacity-30 transform-gpu scale-[1.12] sm:scale-[1.18] translate-y-6 sm:translate-y-8 lg:translate-y-10 brightness-[0.72] contrast-[1.3] drop-shadow-[0_0_95px_rgba(255,69,0,0.32)]"
          loading="eager"
          decoding="async"
          draggable={false}
        />
