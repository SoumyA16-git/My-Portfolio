...
export const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappNumber = (siteData.whatsapp || '917377504790').replace(/[^0-9]/g, '');
  ...
  return (
    <section
      id="contact"
      className="relative w-full max-w-full bg-[#0A0A0A] text-white overflow-hidden isolate py-[clamp(3.5rem,5.5vw,6.5rem)]"
    >
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-[clamp(2rem,3vw,3.5rem)] items-center">
          
          {/* Left Column: Heading, Info & Frameless 3D World Map (Cols 1-6) */}
          <div className="lg:col-span-6 flex flex-col space-y-[clamp(1.25rem,2vw,1.75rem)]">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <p className="text-[15px] sm:text-[17px] lg:text-[clamp(15px,1.1vw,18px)] text-white/75 leading-relaxed font-normal max-w-xl font-sans">
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-xs sm:text-sm text-white/70 pt-1 font-sans font-medium">
                ...
                <a
                  href={`tel:${siteData.phone || '+917377504790'}`}
                  className="text-white hover:text-[#FF4500] transition-colors underline-offset-4 hover:underline"
                >
                  {siteData.phone || '+91 73775 04790'}
                </a>
                <span className="text-white/30">•</span>
            ...
            <div className="relative w-full h-[clamp(210px,20vw,320px)] pt-1 flex items-center justify-center select-none">
