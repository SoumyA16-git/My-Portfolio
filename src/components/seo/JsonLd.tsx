...
export function personSchema() {
  return {
    ...
    url: "https://daswebsolutions.me",
    image: "https://daswebsolutions.me/its_me.webp",
...
export function websiteSchema() {
  return {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: "https://daswebsolutions.me/work?q={search_term_string}",
      },
...
export function projectSchema(project: {
  ...
  return {
    ...
    "@type": "CreativeWork",
    name: project.title,
    url: `https://daswebsolutions.me/work/${project.slug}`,
...
export function projectListSchema(
  ...
  return {
    ...
    url: "https://daswebsolutions.me/work",
    description:
    ...
    itemListElement: projects.map((p, i) => ({
      ...
      position: i + 1,
      name: p.title,
      url: `https://daswebsolutions.me/work/${p.slug}`,
